...
const HeroSection = ({ onPlay, onMoreInfo }: HeroSectionProps) => {
  return (
    <div className="relative h-screen min-h-[600px] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-end h-full pb-32 md:pb-40 px-4 md:px-12">
        ...
        >
          ...
          <span className="border border-muted-foreground/50 px-1 text-xs text-muted-foreground">
            16+
          </span>
        ...
        >
          Feliz Aniversario mi amor! Esta es nuestra serie, la mas linda jamas
          contada, llena de momentos inolvidables, viajes magicos y episodios que
          llevo en mi corazon. Gracias por ser mi mi amor eterno y la protagonista
          de esta historia.
        </p>
      ...
      <div className="absolute bottom-20 right-10 opacity-50">
        <Heart
          className="w-4 h-4 text-primary animate-float-heart"
          style={{ animationDelay: "0s" }}
        />
      </div>
      <div className="absolute bottom-32 right-20 opacity-40">
        <Heart
          className="w-3 h-3 text-primary animate-float-heart"
          style={{ animationDelay: "1s" }}
        />
      </div>
      <div className="absolute bottom-16 right-32 opacity-30">
        <Heart
          className="w-5 h-5 text-primary animate-float-heart"
